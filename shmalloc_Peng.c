...
// Peng Zhao '15
// Normalize the shmalloc pointer to a multiple of 4. Very important!
// If don't do this, segmentation faults will occur (can't be mapped to any slave ports).
    if (shmem_next % 4 != 0){
	shmem_next += (4 - shmem_next % 4);
    }
